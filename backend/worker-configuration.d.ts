/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 2236c5561c31243d8653b8e4606d7729)
// Runtime types generated with workerd@1.20260609.1 2026-06-11 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	INK_FOLD_BANNED_USERS: KVNamespace;
	JWT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "REFRESH_JWT_SECRET" | "DATABASE_URL" | "UNSPLASH_ACCESS_KEY" | "RESEND_API_KEY" | "GROQ_API_KEY" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN">> {}
}
